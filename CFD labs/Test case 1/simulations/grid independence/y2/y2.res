 ...
 ************************************************************
 ...
 Number used before BFC allowance is                         247302
 Number used after BFC allowance is                          247302
 biggest cell volume divided by average is     1.41434989457002       at:
 ix = 1 iy = 13 iz = 216
 xg =0.5 yg =0.057748 zg =1.61625
 smallest cell volume divided by average is   0.109677110632317       at:
 ix = 1 iy = 1 iz = 154
 xg =0.5 yg =2.777045E-03 zg =1.15125
 ratio of smallest to biggest is   7.754595312898881E-002
 ************************************************************
 ...
 ************************************************************
 ...
 PATCH(OB2 ,HIGH , 1, 1, 1, 20, 300, 300, 1, 1)
 COVAL(OB2 ,P1 ,1000. ,0. )
 COVAL(OB2 ,V1 ,0. ,0. )
 COVAL(OB2 ,W1 ,0. ,0. )
 
   Parent VR object for this patch is: PLAT3         
 PATCH(OB3 ,NWALL , 1, 1, 20, 20, 1, 300, 1, 1)
 COVAL(OB3 ,W1 ,1. ,0. )
 XCYCLE = F
 EGWF = F
 ************************************************************
 ...
 *** grid-geometry information ***
 ...
 Total number of F-array elements used is                    248013
 --- INTEGRATION OF EQUATIONS BEGINS ---
 
 ************************************************************
 Run ending on sweep   937 with all residuals below RESFAC ( 1.000000E-05)
 ************************************************************
 *** End of sweep 938
 ************************************************************
 
 ************************************************************
 Whole-field residuals before solution at sweep 938
 with resref values determined by EARTH
 & resfac=1.0E-05
  variable   resref  (res sum)/resref  (res sum)
     P1     2.466E+00   5.460E-10      1.347E-09
     V1     3.606E+00   1.084E-06      3.909E-06
     W1     3.606E+00   9.519E-06      3.432E-05
 
 max abs corrections for solved-for variables
 for comparison with maximum & minimum values
  variable   max-cor      high           low     (   IX    IY    IZ)
     P1     1.066E-04   6.491E+02      2.210E-02 (    1,    6,  231)
     V1     1.083E-07   1.589E-03     -9.123E-02 (    1,    6,  300)
     W1     2.234E-06   8.948E-01      1.006E-02 (    1,    1,  295)
 ...
 ************************************************************
 ...
 Nett source of V1   at patch named: OB2      (OUTL2       ) =-7.427247E-04
 pos. sum=0. neg. sum=-7.427247E-04
 nett sum=-7.427247E-04
 
 Nett source of W1   at patch named: OB1      (INLE1       ) = 5.182642E-01
 Nett source of W1   at patch named: OB2      (OUTL2       ) =-6.887060E-01
 Nett source of W1   at patch named: OB3      (PLAT3       ) =-1.476963E+00
 pos. sum=0.518264 neg. sum=-2.165669
 nett sum=-1.647405
 ...
 ************************************************************
 Summary of sources from all Objects/Patches at sweep   938
    Variable      Inflow        Outflow       Nett
       P1       1.151698E+00 -1.151698E+00 -4.662937E-15
       V1       0.000000E+00 -7.427247E-04 -7.427247E-04
       W1       5.182642E-01 -2.165669E+00 -1.647405E+00
 ************************************************************
 
 
 ************************************************************
 spot values vs sweep or iteration number
 IXMON= 1 IYMON= 20 IZMON= 270 TIMESTEP= 1
 
 Tabulation of abscissa and ordinates...
   ISWP       P1           V1           W1  
      1   0.0000E+00   0.0000E+00   1.0000E-10
    251   4.9236E+01   0.0000E+00   1.0726E-02
    501   4.6668E+01   0.0000E+00   1.0188E-02
    751   4.6114E+01   0.0000E+00   1.0076E-02
   Variable    1 = P1     2 = V1     3 = W1  
     Minval=  0.000E+00  0.000E+00  1.000E-10
     Maxval=  4.924E+01  0.000E+00  1.073E-02
     Cellav=  3.550E+01  0.000E+00  7.747E-03
 1.00 +....+....+....+.3..+....+....+....+....+....+....+
      .                                3                3
 0.90 +                                                 +
      .                                                 .
 ...
 ************************************************************
 ...
 Tabulation of abscissa and ordinates...
   ISWP       P1           V1           W1  
    ...
    251   2.4250E-07   5.6905E-04   3.1077E-02
    501   5.1457E-08   1.0805E-04   4.0060E-03
    751   1.2231E-08   2.4951E-05   2.9850E-04
   Variable    1 = P1     2 = V1     3 = W1  
     Minval= -1.822E+01 -2.190E+01 -8.117E+00
     Maxval=  9.531E-02 -7.472E+00 -1.139E+00
 1.00 3....+....+....+.2..+....+....+....+....+....+....+
      .                                                 .
 0.90 +                                2                +
      .                                                 .
 ...
 ************************************************************
 ...
 Run started at 13:16:14 on Wednesday, 25 June 2025                            
 Run completed at 13:18:24 on Wednesday, 25 June 2025                          
 CPU time of run 130 s
 This includes 130 seconds of user time and 0 seconds of system time.
 TIME/(VARIABLES*CELLS*TSTEPS*SWEEPS*ITS) = 7.700E-06
 ************************************************************
